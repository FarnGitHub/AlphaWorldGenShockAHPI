package AlphaWorldGen.worldgen;
...
public class ChunkProviderGenerateAlpha extends ChunkProviderGenerate {
	private Random rand;
	...
	public ChunkProviderGenerateAlpha(World world, long l) {
		...
		wintermode = ConfigAlphaWorldGen.wintermode();
	}
	...
	public long lastTimeLoaded;
	public Set<ChunkProviderGenerateGenerator> generators = null;
	...
	public Chunk provideChunk(int i, int j) {
		...
		for (ChunkProviderGenerateGenerator generator : generators) {
			generator.preTerrain(this, this.rand, var3, var4, this.biomesForGeneration, var5);
		}
		this.generateTerrain(i, j, var3);

		for (ChunkProviderGenerateGenerator generator : generators) {
			generator.preReplaceBlocks(this, this.rand, var3, var4, this.biomesForGeneration, var5);
		}
		this.replaceBlocksForBiome(i, j, var3);

		for (ChunkProviderGenerateGenerator generator : generators) {
			generator.preCaves(this, this.rand, var3, var4, this.biomesForGeneration, var5);
		}
		this.field_902_u.func_867_a(this, this.worldObj, i, j, var3);

		for (ChunkProviderGenerateGenerator generator : generators) {
			generator.preLight(this, this.rand, var3, var4, this.biomesForGeneration, var5);
		}
		var4.func_1024_c();
		for (ChunkProviderGenerateGenerator generator : generators) {
			generator.post(this, this.rand, var3, var4, this.biomesForGeneration, var5);
		}
		...
		if (WorldGeneratorOverrides.isCustomGenerationEnabledSurface()) {
			for (Map.Entry<BaseMod, SettingSupplier<Boolean>> entry : WorldGeneratorOverrides.getModsOverridingGenerateSurface().entrySet()) {
				if (entry.getValue().getValue()) {
					entry.getKey().GenerateSurface(this.worldObj, this.rand, i, j);
				}
			}
		}
	}
	...
	public String makeString() {
		return WorldGeneratorOverrides.getGenerateMakeString();
	}
}
